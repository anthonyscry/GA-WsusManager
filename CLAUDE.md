...
Use the default triage status vocabulary: `needs-triage`, `needs-info`, `ready-for-agent`, `ready-for-human`, `wontfix`. See `docs/agents/triage-labels.md`.

### Domain docs

Single-context layout: root `CONTEXT.md` plus `docs/adr/` when present. See `docs/agents/domain.md`.
...
**Current Version:** 4.1.0 (PowerShell)
...
- x86 and 32-bit updates (kept but not approved - lab is x64 only)
