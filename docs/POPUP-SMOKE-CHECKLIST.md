...
This test launches `Scripts\WsusManagementGui.ps1` in startup-probe mode and fails if startup error popups are detected. The primary evidence is the JSON result file emitted by the probe, not screenshots.
