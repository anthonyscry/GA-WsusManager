...
2. [WsusConfig](#wsusconfig)
3. [WsusDatabase](#wsusdatabase)
4. [WsusHealth](#wsushealth)
5. [WsusServices](#wsusservices)
6. [WsusFirewall](#wsusfirewall)
7. [WsusPermissions](#wsuspermissions)
8. [WsusExport](#wsusexport)
9. [WsusScheduledTask](#wsusscheduledtask)
10. [WsusAutoDetection](#wsusautodetection)
11. [WsusOperationPlan](#wsusoperationplan)
12. [WsusProvisioning](#wsusprovisioning)
13. [WsusGuiShell](#wsusguishell)
14. [WsusProcessHost](#wsusprocesshost)
15. [WsusHostEnvironment](#wsushostenvironment)
16. [WsusRepairPlan](#wsusrepairplan)
17. [WsusRepairHarness](#wsusrepairharness)
18. [WsusDiagnosticResult](#wsusdiagnosticresult)
19. [WsusTestHarness](#wsustestharness)
...
$repair.IisContentPathFixed  # true/false
```
...
Tests WSUS root directory permissions.
...
Sets required permissions on the WSUS root directory.
...
#### Get-WsusServiceName
Gets service name by configured service type.

```powershell
Get-WsusServiceName -Service SqlExpress   # MSSQL$SQLEXPRESS
Get-WsusServiceName -Service Wsus         # WSUSService
Get-WsusServiceName -Service Iis          # W3SVC
```
...
```powershell
Get-WsusTimeout -Type SqlQueryDefault  # 120
Get-WsusTimeout -Type SqlQueryLong     # 600
Get-WsusTimeout -Type ServiceStart     # 60
```
